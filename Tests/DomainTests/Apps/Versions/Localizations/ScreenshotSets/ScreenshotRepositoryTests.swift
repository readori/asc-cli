...
struct ScreenshotRepositoryTests {
    ...
    @Test func `list screenshot sets returns sets for localization`() async throws {
    ...
    @Test func `list screenshots returns screenshots for set`() async throws {
        let mock = MockScreenshotRepository()
        let screenshots = [
    ...
    @Test func `list screenshots returns empty for set with no screenshots`() async throws {
        let mock = MockScreenshotRepository()
